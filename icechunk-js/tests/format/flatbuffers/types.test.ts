...
describe("asObjectId12", () => {
  ...
  it("should throw for empty array", () => {
    ...
    expect(() => asObjectId12(bytes)).toThrow(
      "Invalid ObjectId12: expected 12 bytes, got 0",
    );
  });
  ...
  it("should throw for too-short array", () => {
    ...
    expect(() => asObjectId12(bytes)).toThrow(
      "Invalid ObjectId12: expected 12 bytes, got 8",
    );
  });
  ...
  it("should throw for too-long array", () => {
    ...
    expect(() => asObjectId12(bytes)).toThrow(
      "Invalid ObjectId12: expected 12 bytes, got 16",
    );
  });
  ...
  it("should throw for 11-byte array (off by one)", () => {
    ...
    expect(() => asObjectId12(bytes)).toThrow(
      "Invalid ObjectId12: expected 12 bytes, got 11",
    );
  });
  ...
  it("should throw for 13-byte array (off by one)", () => {
    ...
    expect(() => asObjectId12(bytes)).toThrow(
      "Invalid ObjectId12: expected 12 bytes, got 13",
    );
  });
});
...
describe("asObjectId8", () => {
  ...
  it("should throw for empty array", () => {
    const bytes = new Uint8Array(0);
    expect(() => asObjectId8(bytes)).toThrow(
      "Invalid ObjectId8: expected 8 bytes, got 0",
    );
  });
  ...
  it("should throw for too-short array", () => {
    ...
    expect(() => asObjectId8(bytes)).toThrow(
      "Invalid ObjectId8: expected 8 bytes, got 4",
    );
  });
  ...
  it("should throw for too-long array", () => {
    ...
    expect(() => asObjectId8(bytes)).toThrow(
      "Invalid ObjectId8: expected 8 bytes, got 12",
    );
  });
  ...
  it("should throw for 7-byte array (off by one)", () => {
    ...
    expect(() => asObjectId8(bytes)).toThrow(
      "Invalid ObjectId8: expected 8 bytes, got 7",
    );
  });
  ...
  it("should throw for 9-byte array (off by one)", () => {
    ...
    expect(() => asObjectId8(bytes)).toThrow(
      "Invalid ObjectId8: expected 8 bytes, got 9",
    );
  });
});
