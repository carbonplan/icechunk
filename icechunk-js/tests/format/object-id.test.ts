...
describe("decodeBase32", () => {
  ...
  it("should throw on invalid character U", () => {
    expect(() => decodeBase32("U")).toThrow(
      "Invalid Base32 Crockford character: U",
    );
  });

  it("should throw on invalid special characters", () => {
    expect(() => decodeBase32("ABC@DEF")).toThrow(
      "Invalid Base32 Crockford character",
    );
  });
});
...
describe("encodeObjectId12", () => {
  ...
  it("should throw for wrong byte length", () => {
    ...
    expect(() => encodeObjectId12(new Uint8Array(15))).toThrow(
      "Expected 12 bytes",
    );
  });
});
